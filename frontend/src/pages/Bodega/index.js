                                    ...
                                    <Col lg={12}>
                                        <div className="mb-4">
                                            ...
                                            <AvField
                                                ...
                                                validate={{ required: { value: true, errorMessage: 'La cantidad mínima del producto es requerida' }, max: { value: product.cantidad, errorMessage: 'La cantidad mínima debe ser menor o igual a la cantidad' } }}
                                            />
                                        </div>
                                    </Col>
                                </Row>
